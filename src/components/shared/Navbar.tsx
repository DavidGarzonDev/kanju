...
export const Navbar = () => {
    return <header className="bg-white text-black py-4 items-center flex justify-between px-5 border-b border-slate-200 lg:px-12">
        <Logo />
        ...
        <button className="relative">
            ...
            <HiOutlineShoppingBag size={25} className="text-slate-700" />
        </button>
        </div>
